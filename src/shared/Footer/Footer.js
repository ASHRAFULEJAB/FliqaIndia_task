    ...
    <footer class="bg-white dark:bg-black">
      <div class="container px-6 py-12 mx-auto">
          ...
          <div class="sm:col-span-2">
            ...
            <div class="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
              <input
                id="email"
                type="text"
                class="px-10 py-2 text-gray-700 bg-white border rounded-3xl
                     dark:bg-gray-100 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400
              ...
              text-gray-500 transition-colors duration-300 transform md:w-auto 
              focus:outline-none bg-gray-300 rounded-3xl hover:bg-gray-700 focus:ring 
              focus:ring-gray-300 focus:ring-opacity-80"
              >
                Subscribe
              </button>
            </div>
            <h1 class="max-w-lg text-xl mt-4  font-semibold tracking-tight text-gray-800 xl:text-2xl dark:text-white">
              Be in touch
            </h1>
            <div class="flex -mx-2">
              <Link
        ...
        <div className="flex">
          ...
          <div class="text-center lg:ml-96 mt-16">
            <h1 className="text-gray-400 text-center">
              2019-2021, FliqaIndia Pvt Ltd.{" "}
              <span className="ml-3">-ALL RIGHT RESERVED</span> <br />
              POWERED BY FLIQAINDIA PVT. <br /> LTD. VERSION 5.1.5
            </h1>
          </div>
        </div>
      </div>
